Catalog of public available datasets
-------------------------------------
-------------------------------------
...
* `ECMWF UK weather datasets <http://apps.ecmwf.int/datasets/>`_
...
* `Accelerometer data <http://www.cis.fordham.edu/wisdm/dataset.php>`_
