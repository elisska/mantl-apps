...
# Class Name
TERAGEN_CLASS_NAME="com.cisco.mantl.terasort.TeraGen"
TERASORT_CLASS_NAME="com.cisco.mantl.terasort.TeraSort"
TERAVAL_CLASS_NAME="com.cisco.mantl.terasort.TeraValidate"
